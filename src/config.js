...
export default {
  ...
  VAINGLORY: {
    ...
    RESPONSES: {
      ...
      REPLY_429_MSG:
        "Request rate limited. Free for non-commercial use for up to 10 requests per minute! To increase your rate limit, please contact api@superevilmegacorp.com"
    }
  },
  ...
  CACHE: {
    ...
    REDIS_HEROES_STATS_INDIVIDUAL_CACHE_EXPIRE: hours(12)
  }
};
